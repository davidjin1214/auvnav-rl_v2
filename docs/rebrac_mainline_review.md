...
> - **N2' 订正（2026-08-17）**：上一行原写两种子 `[42=0.000, 0=0.000]` 且称机制"三 candidate 见 v2 report §4"，**两处均已过时**——seed 43 于 2026-07-12 同协议补齐（三种子合计 **0/90**，rule-of-three 95% 上界 ≈ **0.033**；2026-08-16 那轮只改了 N0 行，漏了本行）；且 candidate 已非三选一，**asym-critic ablation（v2 report §4.5，2026-05-27）排除了 critic 侧**，verdict `ACTOR_FUNDAMENTAL_CONFIRMED`——完美 hull-integral flow 全程喂 critic，s0 actor success 仍 0.000（asym 侧三种子同样 0/90）
