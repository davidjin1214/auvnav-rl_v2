...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional agent filename relative to the run directory.",
    )
    ...
    benchmark_manifest = maybe_load_benchmark_manifest(args.manifest or trainer_state.get("manifest"))
