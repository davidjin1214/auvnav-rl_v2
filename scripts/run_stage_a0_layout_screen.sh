...
SAVE_ROOT="${SAVE_ROOT:-experiments/protocol_screen_v2/A0_single_u10_cross_tgt15/${OBJECTIVE}}"

FLOW_PATH="wake_data/wake_v8_U1p00_Re150_D12p00_dx0p60_Ti5pct_1200f_roi.npy"
MANIFEST_PATH="benchmarks/single_u10_cross_tgt15.json"

echo "[A0] generating manifest: ${MANIFEST_PATH}"
