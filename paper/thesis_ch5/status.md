...
| 整改批次 | 第 1 批（C1/C2 + M8/M9/M16，轻流程）✅ **已闭环 2026-07-21** ｜ 第 2 批（H1/H3/H5 + M11/M6，重流程）✅ **已闭环 2026-07-21** ｜ 第 3 批（H2 + §8 N1/N2 + M13，重流程）✅ **已闭环 2026-07-22** ｜ 第 4 批（H4/H6/H7 + M1/M3/M12，重流程）✅ **已闭环 2026-07-24** ｜ 第 5 批（余 MED/LOW + CH2 + §8 N3/N4 + §9 N7–N11 + §10 新增 N12–N18）⏳ |
...
| 待用户裁断 | findings §5 两条正面挑战：CH2（贡献类型声明前移 §5.1）／CH3（生物母题中段一次回声）。**CH1 已裁断**（2026-07-24：§5.2 自足补一支，不采跨章指针写法）；findings §8 **N1** 已于第 3 批闭环 |
